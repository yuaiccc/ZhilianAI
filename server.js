...
2. ！！重要！！你需要以严格的 JSON 格式输出，包含对刚刚候选人回答的好感度打分(0-100分)、你的提问回复、以及 3 个供候选人选择的可能回答。
   JSON格式必须为：{"score": 75, "reply": "你的提问内容...", "options": ["选项A（如：我很稳定）", "选项B", "选项C"]} 
`;
...
2. ！！重要！！你需要以严格的 JSON 格式输出，包含对刚刚候选人回答的好感度打分(0-100分)、你的提问回复、以及 3 个供候选人选择的可能回答。
   JSON格式必须为：{"score": 75, "reply": "你的提问内容...", "options": ["选项A（如：我用过xxx技术解决过）", "选项B", "选项C"]} 
`;
...
2. ！！重要！！你需要以严格的 JSON 格式输出，包含对刚刚候选人回答的好感度打分(0-100分)、你的提问回复、以及 3 个供候选人选择的可能回答。
   JSON格式必须为：{"score": 75, "reply": "你的提问内容...", "options": ["选项A（如：我喜欢挑战）", "选项B", "选项C"]} 
`;
